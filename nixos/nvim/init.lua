...
local vimk = {
  name = "nvim",
  d = { "<cmd>e ~/Projects/dz-nixos/nixos/nvim/<cr>", "open vim directory" },
  v = { "<cmd>e ~/Projects/dz-nixos/nixos/init.vim<cr>", "edit `init.vim`" },
  l = { "<cmd>e ~/Projects/dz-nixos/nixos/init.lua<cr>", "edit `init.lua`" },
  n = { "<cmd>e ~/Projects/dz-nixos/nixos/config.nix<cr>", "edit neovim `config.nix`" },
  g = { "<cmd>e ~/Projects/dz-nixos/nixos/neovide.nix<cr>", "edit `neovide.nix`" },
}

local configk = {
  name = "configs",
  d = { "<cmd>e ~/Projects/dz-nixos/nixos/<cr>", "open config directory" },
  v = vimk,
}
